...
import { financialEntries, paymentLabels } from '@/data/mockData';
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="stat-card">
          ...
          <p className={cn('text-xl font-bold font-display', profit >= 0 ? 'text-primary' : 'text-destructive')}>
            R$ {profit.toFixed(2)}
          </p>
        </div>
      </div>
        ...
        {entries.map((entry, i) => (
          ...
          >
            <div className={cn(
              ...
              entry.type === 'entrada' ? 'bg-success/15' : 'bg-destructive/15'
            )}>
              {entry.type === 'entrada'
